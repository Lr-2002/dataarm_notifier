...
async def test_with_mock_data():
    ...
    print(f"Cached joint IDs: {len(getattr(server, '_can_id_to_joint_id', {}) or {})}")
    ...
    print("  - can/bus/errors_per_s")
    print("  - can/bus/drops_per_s")
    print("  - can/rtt/mean")
    print("  - can/rtt/q95")
    print("  - can/fps/{joint_id}")
    print("  - can/jitter/{joint_id}")
    print("  - can/jitter_q95/{joint_id}")
    print("  - can/rtt/{joint_id}")
